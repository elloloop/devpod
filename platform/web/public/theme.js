...
window.DevpodTheme = (function () {
  ...
  var K = [
    ...
    '--dp-accent','--dp-accent-hover','--dp-accent-contrast',
  ...
  var S = {
    default: {
      ...
      d:['#0a0a0a','#111111','#171717','#1c1c1c','#222222','#262626','#1a1a1a','#e5e5e5','#a3a3a3','#525252','#ffffff','#e5e5e5','#0a0a0a','#22c55e','#ef4444','#f59e0b','#a3a3a3','#0e0e0e','#3a3a3a','#0a2010','#0f3018','#200a0a','#3a1010','#0d1018','#a3a3a3','#e5e5e5','#86efac','#525252','#e5e5e5','#fca5a5','#171717','#e5e5e5','vs-dark'],
      l:['#ffffff','#fafafa','#f5f5f5','#eeeeee','#e5e5e5','#d4d4d4','#e5e5e5','#0a0a0a','#525252','#a3a3a3','#0a0a0a','#171717','#ffffff','#16a34a','#dc2626','#d97706','#525252','#fafafa','#a3a3a3','#f0fdf4','#dcfce7','#fef2f2','#fecaca','#f5f5f5','#525252','#0a0a0a','#16a34a','#9ca3af','#525252','#ea580c','#0a0a0a','#ffffff','light']
    },
    github: {
      label:'GitHub', accent:'#58a6ff',
      d:['#0d1117','#161b22','#1c2128','#1c2128','#282e33','#30363d','#21262d','#e6edf3','#8b949e','#484f58','#58a6ff','#79c0ff','#000000','#3fb950','#f85149','#d29922','#58a6ff','#0d1117','#3b4252','#12261e','#1a4028','#2d1215','#421c1f','#121d2f','#79c0ff','#ff7b72','#a5d6ff','#8b949e','#d2a8ff','#79c0ff','#1f6feb','#fff','vs-dark'],
      l:['#fff','#f6f8fa','#eaeef2','#eaeef2','#d0d7de','#d0d7de','#e1e4e8','#1f2328','#656d76','#8c959f','#0969da','#0550ae','#ffffff','#1a7f37','#cf222e','#9a6700','#0969da','#f6f8fa','#8c959f','#dafbe1','#aceebb','#ffebe9','#ffcecb','#ddf4ff','#0969da','#cf222e','#0a3069','#8c959f','#8250df','#0550ae','#0969da','#fff','light']
    },
    retro: {
      label:'Playful', accent:'#c084fc', structural:true,
      d:['#ffdf6b','#ffffff','#fff8dc','#fff3b0','#fde68a','#000000','#000000','#000000','#333333','#555555','#c084fc','#a855f7','#000000','#4ade80','#f43f5e','#f97316','#22d3ee','#ffffff','#555555','#d9f99d','#bef264','#fce7f3','#fbcfe8','#fef9c3','#2563eb','#2563eb','#f43f5e','#555555','#000000','#4ade80','#c084fc','#000000','light'],
      l:['#ffdf6b','#ffffff','#fff8dc','#fff3b0','#fde68a','#000000','#000000','#000000','#333333','#555555','#c084fc','#a855f7','#000000','#4ade80','#f43f5e','#f97316','#22d3ee','#ffffff','#555555','#d9f99d','#bef264','#fce7f3','#fbcfe8','#fef9c3','#2563eb','#2563eb','#f43f5e','#555555','#000000','#4ade80','#c084fc','#000000','light']
    },
    midnight: {
      label:'Midnight', accent:'#22d3ee',
      d:['#0f172a','#131c33','#1a2540','#1e2d4d','#243555','#1e3a5f','#172e4a','#e2e8f0','#94a3b8','#475569','#22d3ee','#67e8f9','#000000','#34d399','#fb7185','#fbbf24','#60a5fa','#0f172a','#334155','#0d2818','#134028','#2a0f18','#401525','#0c1a30','#22d3ee','#c084fc','#86efac','#475569','#67e8f9','#fda4af','#0e7490','#fff','vs-dark'],
      l:['#f0f9ff','#e0f2fe','#d1ecfc','#c5e7fa','#b0ddf7','#93c5e8','#b6d9f2','#0c4a6e','#1e6b94','#6b9dbb','#0d9488','#0f766e','#ffffff','#16a34a','#dc2626','#d97706','#0284c7','#e0f2fe','#6b9dbb','#dcfce7','#bbf7d0','#fef2f2','#fecaca','#e0f4ff','#0d9488','#7c3aed','#0f766e','#6b9dbb','#0284c7','#b45309','#0f766e','#fff','light']
    },
    rose: {
      label:'Rosé Pine', accent:'#eb6f92',
      d:['#191724','#1f1d2e','#26233a','#2a2740','#312e48','#2a2740','#211f30','#e0def4','#908caa','#6e6a86','#eb6f92','#f4a0b5','#000000','#31748f','#eb6f92','#f6c177','#9ccfd8','#191724','#44405a','#14242e','#1a3440','#2e1420','#401a2a','#1c1830','#c4a7e7','#c4a7e7','#f6c177','#6e6a86','#eb6f92','#9ccfd8','#eb6f92','#fff','vs-dark'],
      l:['#faf4ed','#f2e9e1','#eaddd3','#e2d5c8','#d7ccc0','#d4c8bc','#e0d5c8','#286983','#575279','#9893a5','#d7827e','#c5645f','#ffffff','#56949f','#b4637a','#ea9d34','#56949f','#f2e9e1','#9893a5','#e4f0e8','#c9e4d0','#f5e0e4','#f0c8d0','#f0e8e0','#907aa9','#907aa9','#ea9d34','#9893a5','#d7827e','#56949f','#d7827e','#191724','light']
    }
  };
